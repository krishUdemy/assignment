...
supportsAdoptingStyleSheets, unsafeCSS, UpdatingElement } from "../../lit-element/lit-element.js"; // lit-html

export { AttributePart, BooleanAttributePart, directive, EventPart, html, isDirective, isPrimitive, noChange, NodePart, nothing, PropertyPart, render, svg, SVGTemplateResult, TemplateResult } from "../../lit-html/lit-html.js";
...
export { render as renderShady } from "../../lit-html/lib/shady-render.js"; // open-wc

export { ScopedElementsMixin } from "../../@open-wc/scoped-elements/index.js";
export { dedupeMixin } from "../../@open-wc/dedupe-mixin/index.js"; // ours
