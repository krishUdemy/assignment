import { LitElement, SlotMixin } from "../../core/index.js";
...
export class LionField extends FormControlMixin(InteractionStateMixin(FocusMixin(FormatMixin(ValidateMixin(DisabledMixin(SlotMixin(LitElement))))))) {
