...
export function fakeExtendsEventTarget(instance) {
  ...
  const delegatedMethodAdd = (type, listener, opts) => delegate.addEventListener(type, listener, opts);
  /**
  ...
  const delegatedMethodRemove = (type, listener, opts) => delegate.removeEventListener(type, listener, opts);
