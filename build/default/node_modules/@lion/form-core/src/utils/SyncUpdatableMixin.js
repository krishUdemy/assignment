import { dedupeMixin } from "../../../core/index.js"; // TODO: will be moved to @Lion/core later?
...
const SyncUpdatableMixinImplementation = superclass => class SyncUpdatable extends superclass {
  constructor() {
  ...
  __syncUpdatableInitialize() {
    ...
    const ctor =
    /** @type {SyncUpdatableMixin & SyncUpdatable} */
    this.constructor;
