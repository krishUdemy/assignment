...
const FormatMixinImplementation = superclass => class FormatMixin extends superclass {
  ...
  disconnectedCallback() {
    ...
    if (this._inputNode) {
      ...
      this._inputNode.removeEventListener(this.formatOn, this._reflectBackFormattedValueDebounced);
    }
  }
