import { browserDetection, css, DisabledWithTabIndexMixin, html, LitElement, SlotMixin } from "../../core/index.js";

const isKeyboardClickEvent = e => e.keyCode === 32
/* space */
|| e.keyCode === 13;
/* enter */


const isSpaceKeyboardClickEvent = e => e.keyCode === 32 || e.key === 32;
/* space */
  ...
  render() {
    return html`
      <div class="btn">
        ...
        ${browserDetection.isIE11 ? html`<div id="${this._buttonId}"><slot></slot></div>` : html`<slot></slot>`}
        ${this._afterTemplate()}
